...
# Set RTC to a fixed time (for testing purposes, you can remove this after testing)
rtc.datetime((2025, 4, 2, 0, 12, 30, 0, 0))  # Set RTC to April 2, 2025, 12:30:00 (year, month, day, weekday, hour, minute, second, subsecond)
...
def get_rtc_time():
    ...
    return f"{year}-{month:02}-{day:02} {hours:02}:{minutes:02}:{seconds:02}"
